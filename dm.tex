...
The approach that will be taken to verifying each requirement is described in the {\it DM Acceptance Test Specification,} (\citeds{LDM-639}), which provides the dedicated test specifications for major components of Data Management.
