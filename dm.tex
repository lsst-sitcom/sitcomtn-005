...
\item The DM Verification Control Document, \citeds{LDM-692}, which provides the verification matrix for all DMSR requirements and Specifications, as defined in \cite{LSE-61};
