...
\begin{figure}[htbp]
    \begin{center}
    \includegraphics[width=1\textwidth]{./sv_surveys_coverage_coordinates.png}
...
\begin{figure}[htbp]
    ...
    \caption{SV surveys cumulative tempate coverage area in each of the ugrizy bands. Numbers in the upper left represent the total template coverage area in square degrees at the conclusion of the SV survey simulation, listed separately for each band.}
